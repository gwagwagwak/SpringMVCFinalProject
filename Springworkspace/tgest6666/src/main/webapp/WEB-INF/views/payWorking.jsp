              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="left" valign="top" style="padding-bottom:2px !important;text-align:left;vertical-align:top">
                    <input type="radio" class="paymentTypeRadios" id="input_3_paymentType_express" name="q3_myProducts3[paymentType]" checked="" value="paylog" onclick="onOff(this.value,'card');"/>
                  ...
                  <div>
                                          <c:if
															test="${card.getC_name() eq '카카오 카드'}">
																...
																<img src="${pageContext.request.contextPath}/resources/img/kakaocard.PNG" style="width:220px; height:130px">
															
														</c:if> <c:if test="${card.getC_name() eq 'NH농협 카드'}">
															

																<img src="${pageContext.request.contextPath}/resources/img/NHcard.PNG" style="width:220px; height:130px">

														</c:if> <c:if test="${card.getC_name() eq 'KB국민 카드'}">
															

																<img src="${pageContext.request.contextPath}/resources/img/kbcard.PNG" style="width:220px; height:130px">
															
														</c:if> <c:if test="${card.getC_name() eq '삼성 카드'}">
															


																<img src="${pageContext.request.contextPath}/resources/img/samsungcard.PNG" style="width:220px; height:130px">
															
														</c:if> <c:if test="${card.getC_name() eq '현대 카드'}">
															

																<img src="${pageContext.request.contextPath}/resources/img/hyundaicard.PNG" style="width:220px; height:130px">
															
														</c:if> <c:if test="${card.getC_name() eq '신한 카드'}">
															


																<img src="${pageContext.request.contextPath}/resources/img/shinhancard.png" style="width:220px; height:130px">
