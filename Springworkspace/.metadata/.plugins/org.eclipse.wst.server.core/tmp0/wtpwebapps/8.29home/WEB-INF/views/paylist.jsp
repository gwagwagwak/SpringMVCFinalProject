...
<script type="text/javascript">
	/* 페이징 처리 스크립트 */
	function list(page) {
		location.href = "paylist.do?curPage=" + page;
	};
</script>
<script async="" defer=""
	...
	<div
		...
		<div class="vx_globalNav-container">
			...
			<div class="vx_globalNav-secondaryNav_mobile">
				...
				<div>
					<p class="vx_h5 vx_globalNav-displayName">${loginMember.m_lname }</p>
				</div>
			</div>
			<div class="vx_globalNav-navContainer">
				<nav class="vx_globalNav-nav" role="navigation">
					<ul class="vx_globalNav-list">
						...
						<li class="vx_isActive"><a href="paylist.do"
	...
	<div id="js_foreground"
		...
		<div class="vx_globalNav-main_mobile">
			...
			<div class="vx_globalNav-headerSection_logo">
				<a href="mainHome.do" id="header-ppLogo_mobile"
								...
								<section id="js_filterView" class="filters-container"
									...
									<section class="filters-section js_filters-section">
										...
										<form name="filtersForm" class="filters-form"
											class="filters-form" id="js_filters-form" action="paylist.do">
											...
											<div class="vx_form-group elasticSearch">
												<div
													...
													<label class="elasticSearch-label accessAid">☃search.label☃</label><input
														id="p_targetSearch" name="p_targetSearch" type="text"
							...
							<section class="activityModule nemo_activityModuleNone"
								...
								<c:if test="${!empty plist}">
									<table class="table table-striped table-hover">
										...
										<tbody>
											<c:forEach var="plist" items="${plist}" begin="0" end="9">
												<tr>
													<td>
														...
														pattern="yyyy-MM-dd HH:mm:ss.S" scope="page" /> 
														 <fmt:formatDate
														value="${m_joindate2}" pattern="yyyy.MM.dd" />
													</td>
									...
									<div class="container" style="text-align:center;">
										<ul class="pagination">
											...
											<c:if test="${pager.curBlock >= 1}">
												<li><a href="javascript:list('${pager.prevPage}')">[이전]</a></li>
											</c:if>
											...
											<c:if test="${pager.curBlock-1 <= pager.totBlock}">
												<li><a href="javascript:list('${pager.nextPage}')">[다음]</a></li>
											</c:if>

											<c:if test="${pager.curPage <= pager.totPage}">
												<li><a href="javascript:list('${pager.totPage}')">[끝]</a></li>
											</c:if>
										</ul>
									</div>
								</c:if>
				...
				<div class="vx_globalFooter-content">
					<ul class="vx_globalFooter-list">
						...
						<li><a href="shopping.do" data-pagename=""
							...
							id="footer-security">구매하러 가기</a></li>
					</ul>
