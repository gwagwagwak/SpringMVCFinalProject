...
<body class="landing-page landing-page1">
	...
	<!--이메일 문의하기  -->
		<form action="qnamainsend.do" method="post">
		<div class="section section-features">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" name="qm_title"
									id="validate-text" placeholder="제목을 입력하세요" required> 
									<input type="hidden" name="qm_receivcemail" value="rmfhwlt0@naver.com">
									<span
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" name="qm_sendermail"
				...
				<div class="form-group green-border-focus">
					...
					<textarea class="form-control" id="exampleFormControlTextarea5" name="qm_content"
						rows="3" placeholder="문의글을 입력하세요"></textarea>

				</div>
					<input class="btn btn-primary btn-sm btn-fill" type="submit" value="전송">	
		...
		<div class="section section-no-padding">
			<div class="parallax filter-gradient blue" data-color="blue">
				...
				<div class="info">
					...
					<a href="loginForm.do" class="btn btn-neutral btn-lg btn-fill">Get
						Started</a>
				</div>
			</div>
		</div>
