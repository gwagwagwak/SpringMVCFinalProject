...
<body class="vx_root  vx_addFlowTransition">
				...
				<div class="vx_globalNav-navContainer">
					<nav class="vx_globalNav-nav" role="navigation">
						<ul class="vx_globalNav-list">
							<li class=""><a href="loginSuccess.do" target="_self"
							...
							<li class="vx_isActive"><a href="actionCardAfter.do"
										...
										<ul class="cw_panel cw_panel_messages" id="cw_panel-messages">
											<li class="cw_notification"><div
												...
												<div class="cw_notification-description">새로운 메시지가
													없습니다.</div> <a href="/selfhelp/smc/" class="cw_notification-link"
	...
	<div class="vx_foreground-container foreground-container">
		...
		<section class="vx_mainContent contents" id="contents" role="main">
					...
					<div id="paymentlist" name="paymentlist">
						<ul class="fiList test_fiList js_fiList" tabindex="-1">
							...
							<c:forEach var="clist" items="${clist}" begin="0" end="2">
								<li class="fiList-item "><a
									href="getCard.do?c_number=${clist.getC_number() }"
									data-name="viewCard" class="fiListItem-link test_navItem-card"
									pa-marked="1"> <span class="fiListItem-row table-row">
											<span
											class="fiListItem-col table-col-xs fiListItem-statusIcon">

										</span> <span
											class="fiListItem-col table-col-xs fiListItem-typeIcon undefined">
												<c:if test="${clist.getC_name() eq '카카오 카드'}">
										...
										</span> <span class="fiListItem-col table-col-xs"> <span
												class="fiListItem-identifier">${clist.getC_name()} </span> <span
												class="fiListItem-subText">${clist.getC_type() } <span
													dir="ltr">${clist.getC_number() }</span>
											</span>
			...
			<section
				class="col-sm-8 accountPage-sections fiDetailArea-container ">
				<div class="fiDetails-container js_fiDetails-container"
					tabindex="-1">
					<a href="/myaccount/money" data-name="backButton"
						class="vx_backBtn fiDetails-backBtn invisibleForDesktop"
						pa-marked="1">뒤로</a>
					<div class="fiDetails">

						<span class="product-logo product-logo_balance "> <span
							class="monogram-logo-group"> <c:if
									test="${card.getC_name() eq '카카오 카드'}">



									<img
										src="${pageContext.request.contextPath}/resources/img/kakaocard.PNG"
										style="width: 220px; height: 130px">

								</c:if> <c:if test="${card.getC_name() eq 'NH농협 카드'}">


									<img
										src="${pageContext.request.contextPath}/resources/img/NHcard.PNG"
										style="width: 220px; height: 130px">

								</c:if> <c:if test="${card.getC_name() eq 'KB국민 카드'}">


									<img
										src="${pageContext.request.contextPath}/resources/img/kbcard.PNG"
										style="width: 220px; height: 130px">

								</c:if> <c:if test="${card.getC_name() eq '삼성 카드'}">



									<img
										src="${pageContext.request.contextPath}/resources/img/samsungcard.PNG"
										style="width: 220px; height: 130px">

								</c:if> <c:if test="${card.getC_name() eq '현대 카드'}">


									<img
										src="${pageContext.request.contextPath}/resources/img/hyundaicard.PNG"
										style="width: 220px; height: 130px">

								</c:if> <c:if test="${card.getC_name() eq '신한 카드'}">



									<img
										src="${pageContext.request.contextPath}/resources/img/shinhancard.png"
										style="width: 220px; height: 130px">
						...
						<div class="vx_text-3_regular"
							style="width: 100%; height: 50px; align-items: center">
								...
								<div style="display: flex; justify-content: center">
									...
									<table style="width: 100%;">
										...
										<tr>
											...
											<td>${card.getC_type()}</td>
										</tr>
										<tr>
											<td style="text-align: left;">만료일</td>
											<td>${card.getC_expr()}</td>
										</tr>
										<tr>
											<td style="text-align: left;">청구 주소</td>
											<td>${card.getC_addr()}</td>
										</tr>
						...
						<hr class="vx_hr-alt fiDetails-hr">
						<a class="balanceDetails-manageCurrencies test_mcm-addCurrency"
							pa-marked="1" onclick="removeCheck()">-<!-- --> <!-- -->결제수단
							삭제
						</a>
					</div>
				</div>
				...
				<div class="vx_globalFooter">
					<div class="vx_globalFooter-content">
						<ul class="vx_globalFooter-list">
							...
							<li><a href="shopping.do" data-pagename=""
								data-name="footer-security" name="footer-security"
								id="footer-security" pa-marked="1">구매하러가기</a></li>
						</ul>
