    ...
    <div class="col-sm-12 noGutter">
        <div class="row">
            <div id="A" class="col-sm-7">
                <span class="vx_text-2_regular welcome-container">안녕하세요! ${loginMember.m_lname} ${loginMember.m_fname} 님<a href="logout.do" class="btn btn-primary">Sign Out</a></span>		<!-- ${loginMember.m_fname} -->
