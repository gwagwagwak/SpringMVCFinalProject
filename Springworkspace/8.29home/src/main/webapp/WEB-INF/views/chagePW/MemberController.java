...
public class MemberController {
	...
	public void loginPost(@ModelAttribute LoginDTO logindto, Model model,HttpServletRequest request) throws Exception {
	...
	public String idCheck(@RequestBody String inputId) throws Exception {
		System.out.println("dmdkdkdkdkjfas;ldfjalsk;dfjlask;djflaksdfj");
		System.out.println(inputId);
		String checkRst="";
		int result = mservice.userIdCheck(inputId);
	...
	// userInfomation으로 가도록 임시로 정해둠
	@RequestMapping(value = "sujeong.do")
	public String sujeong(Model model) throws Exception {

		return "userInfomation";
	}
	// changePasswordForm-여기가 패스워드 바꾸는 창-으로 가도록 임시로 정해둠
	@RequestMapping(value = "ChangePasswordForm.do")
	public String sujeong2(Model model) throws Exception {
